...
function ProductForm({ initialData = null, onClose }: ProductFormProps) {
  ...
  const categoriesOpts = useAppSelector((state) =>
    state.category.categories.map((cate) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div className="textarea-field flex flex-col col-span-2 md:col-span-2">
              ...
              <textarea
                ...
                className={`input input-bordered w-[100%] h-[100px] ${errors.description ? "input-error" : ""
                  }`}
