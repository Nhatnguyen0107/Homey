...
function ProductList() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow p-6 category-list">
            ...
            {loading
              ...
              : products?.map((product, idx) => (
                ...
                >
                  ...
                  <td className="py-3 px-4">
                    <span
                      className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${product.categoryName === "active"
      ...
      <div className="flex items-center justify-between mt-6">
        ...
        <div className="flex gap-1">
          <button
            className={`px-3 py-1 rounded border cursor-pointer ${params.page == 1 && "disabled"
              }`}
          ...
          <button
            className={`px-3 py-1 rounded border cursor-pointer ${params.page == pagination?.totalPages && "disabled"
              }`}
